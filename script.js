...
function genRandQuote() {
  ...
  currentQuote = $("#text").html(randQuote.text);
  currentAuthor = $("#author").html('- ' + randQuote.source);
//   $("#tweet-quote").attr("href", stringToClickToTweetURL('"' + currentQuote + '" - ' + currentAuthor));
...
//   var resultString = "https://twitter.com/intent/tweet?hashtags=quotes&text=" + stringToConvert;
//   return resultString;
